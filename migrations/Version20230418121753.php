...
final class Version20230418121753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercice (id INT AUTO_INCREMENT NOT NULL, seance_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, serie INT DEFAULT NULL, repetition INT DEFAULT NULL, temps INT DEFAULT NULL, recuperation INT NULL, INDEX IDX_E418C74DE3797A94 (seance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
